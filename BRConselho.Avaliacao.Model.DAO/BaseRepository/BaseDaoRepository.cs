...
namespace BRConselho.Avaliacao.Model.DAO.BaseRepository
{
    public class BaseDaoRepository<T> : IBaseDaoInterface<T> where T: BaseEntity
    {
        ...
        {
            string strConnectionString = ConfigurationManager.ConnectionStrings[strConnection].ConnectionString;
